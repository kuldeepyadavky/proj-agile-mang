...
class SubTasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sub_task" do
    assert_difference('SubTask.count') do
      post sub_tasks_url, params: { sub_task: { status: @sub_task.status, task_id: @sub_task.task_id, title: @sub_task.title } }
    end
  ...
  test "should update sub_task" do
    patch sub_task_url(@sub_task), params: { sub_task: { status: @sub_task.status, task_id: @sub_task.task_id, title: @sub_task.title } }
